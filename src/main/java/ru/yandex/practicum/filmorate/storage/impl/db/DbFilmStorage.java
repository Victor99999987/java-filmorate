...
public class DbFilmStorage extends DbStorage implements FilmStorage {
    ...
    private static final String SQL_QUERY_BASE_NO_PARAM_YEAR = "select f.id, f.name, f.description, f.releasedate, f.duration, " +
    ...
    private static final String SQL_QUERY_BASE_LIKES = "select f.id, f.name, f.description, f.releasedate, f.duration, " +
            "f.mpa_id, m.name as mpa_name, fg.genres_id, g.name as genres_name, l.users_id,\n" +
